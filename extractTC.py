...
# NOTE - THIS IS JUST Extraction from PDF's
# Cleanup, standardization/reconcile of data happen in OpenRefine output is dumped as *-clean.csv files. 
# Steps involved are dumped in the cleanup directory as OpenRefine JSON files
...
def mptc_extract():
  ...
  mptc01['year'] = 2001
  mptc['year']=2014
  mptc06['electedas'] = 'MPTC'
  mptc01['electedas'] = 'MPTC'
  mptc['electedas']='MPTC'
...
#clean up 
#find alternate mandal spellings and add them to the mandal_synonyms dict 
#zy=z.groupby(['mandal', 'year']).size().unstack()
#mandals_with_na = zy[zy[2001].isna() | zy[2006].isna() | zy[2014].isna()].index
#['Agandlapent', 'Agarladinne', 'Anantapur', 'Anantapur Rural', 'Ananthapur', 'Ananthapuramu Rural', 'B K Samudram', 'Brahmasamudram', 'Bramhasamudra', 'Bramhasamudram', 'Bukkapatnam', 'Bukkaptnam', 'Bukkarayasamudram', 'C K Palli', 'C.K.Palli', 'Cheruvukotha', 'Cheruvukudair', 'Ck Palli', 'D Hirchal', 'D.Hirehal', 'Gandlapent', 'Gandlapenta', 'Garladdinne', 'Garladinne', 'Kotha', 'Kothacheruvu', 'Mbramhasamudra', 'Mbramhasamudram', 'Mbukkapatnam', 'N P Kunta', 'N.P.Kunta', 'Nallacheru', 'Nallacheruvu', 'Np Kunta', 'O D Cheruvu', 'O.D.Cheruvu', 'Od Cheruvu', 'Pedda Pappur', 'Peddapappur', 'Peddapappuru', 'Puttaparthi', 'Puttaparthy', 'Tadipathri', 'Tadipatri', 'Tadpatri', 'Vunallacheru', 'Vunallamada'] 
